...
#include <utlstring.h>
#include <KeyValues.h>
#include "sdk1/schemasystem.h"
#include "sdk1/CBaseEntity.h"
#include "sdk1/CGameRulesProxy.h"
#include "sdk1/CBasePlayerPawn.h"
#include "sdk1/CCSPlayerController.h"
#include "sdk1/CCSPlayer_ItemServices.h"
#include "sdk1/CSmokeGrenadeProjectile.h"
#include <map>
#ifdef _WIN32
#include <Windows.h>
#include <TlHelp32.h>
...
CON_COMMAND_F(skin, "Skinuri", FCVAR_CLIENT_CAN_EXECUTE)
{
	...
	if(args.ArgC() == 1)
	{
		FnUTIL_ClientPrint(pPlayerController, 3, " \x04 [SKIN] \x01Intra pe: http://skin.ymos.top/ ptr parametrii de modificare skin",nullptr, nullptr, nullptr, nullptr);
		FnUTIL_ClientPrint(pPlayerController, 3, " \x04 [SKIN] \x01Sursa：https://github.com/yuzhouUvU/cs2_weapons_skin",nullptr, nullptr, nullptr, nullptr);
		return;
	}
	char buf[255] = {0};
	if(weaponId == 59 || weaponId == 42)
	{
		if(args.ArgC() != 5)
		{
			sprintf(buf, " \x04 [SKIN] \x01%s Aveți nevoie de patru parametri pentru a modifica pielea cuțitului folosind comanda skin.!",pPlayerController->m_iszPlayerName());
